...
class Sub_Grupos(models.Model):
    ...
    grupo = models.ForeignKey(Grupos, on_delete=models.CASCADE, null=True, blank=True, related_name='sub_grupos')
...
class Tarefa(models.Model):
    ...
    grupo = models.ForeignKey(Grupos, on_delete=models.SET_NULL, null=True, blank=True, related_name='tarefa_grupos')
